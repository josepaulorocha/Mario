...
export class Personagem {
    ...
    // Soma todas as pontuações obtidas nas rodadas.
    ...
    // Consome um item específico do inventário, não necessariamente o do topo.
    ...
    // 40% de chance de desviar de um ataque.
    desviar(): boolean {
